...
if(isset($_POST['submit'] ))
{
	...
	if ($_POST['password']!=null) {
		...
		$error = '<div class="alert alert-danger alert-dismissible fade show">
            ...
            $mql = "update users set username='$_POST[uname]', f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='$pd' where u_id='$_GET[user_upd]' ";
            mysqli_query($db, $mql);
