...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	elseif($_FILES['file']['name'] == null) {
          
        $sql = "update dishe set Category='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
        ...
        if($result > 0){
            ...
            $success = 	'<div class="alert alert-success alert-dismissible fade show">
                        ...
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Record not</strong>Updated.
                    </div>';
                    }
    }else{
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update dishe set Category='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
