        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">All Admins Info</h3> </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <!--<a href="add_admin.php" class="btn btn-outline-primary">+ Add Admin</a>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="add.php?action=addadmin" method="post">
        ...
        <div class="modal-footer">
          ...
          <a role="button" class="btn btn-default"  href="all_admins.php" >Close</a>
